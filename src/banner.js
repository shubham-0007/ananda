...
<div className="banner" >
        <div className="frame">
            ...
            <div className="b_left">
                <p className="b_title"><span style={{"color":"#e9702b"}}>Ananda</span> A Privileged Home</p>
                <p className="b_s_title" >Smile Is natural phenomena and we maintain it.</p>
            </div>
                <div className="b_right ">
                    
                    <p className="a_title"><span style={{"color":"#e9702b"}}>A</span>nanda<br />(A Privileged Home)</p>
                    <p className="t_text">Smile Is natural phenomena and we maintain it.</p><br />
                    <marquee> <p className="w_text">Welcome to Ananda. Have A Nice Day</p> </marquee><br />
                    <p className="p_text">Ananda is a Home for house Senior Citizens who are 
