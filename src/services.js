...
<div className= "col-md-12" style={{"background": "rgba(255,255,255,.5)", "marginTop": "30px","font-size":"4px"}}>
<h3>LODGING</h3>
...
<img className="img-responsive"  src="../image/picserv_3.jpg"  width="70%"/>


          </div>
          <div className="Lodg_1">
<img  className="img-responsive"  src="../image/picserv_6.jpg" width="70%" />


          </div>
          <div className="Lodg_1">

<img className="img-responsive"  src="../image/picserv_5.jpg" width="80%" />
...
<h3>	 BOARDING</h3>
 ...
 Aananda provides the Facility of BOARDING to the Senior Citizen.
        ...
        <div  className = "Lodg" >
         <div className="Lodg_1">
<img className="img-responsive"  src="../image/picserv_7.jpg"  width="70%"/>


          </div>
          <div className="Lodg_1">
<img  className="img-responsive"  src="../image/picserv_10.jpg" width="70%" />


          </div>
          <div className="Lodg_1">

<img className="img-responsive"  src="../image/picserv_4.jpg" width="70%" height="10%" />
...
<h3>ELECTRICITY</h3>
   ...
   Aananda provides the Facility of ELECTRICITY to the Senior Citizen.
        ...
        <div  className = "Lodg" >
         <div className="Lodg_1">
<img  className="img-responsive" src="../image/picserv_elect_1.jpg"   width="70%"/>


          </div>
          <div className="Lodg_1">
<img className="img-responsive" src="../image/picserv_elect_2.jpg"  width="70%" />


          </div>
          <div className="Lodg_1">

<img className="img-responsive" src="../image/picserv_elect_3.jpg" width="70%" />
...
<h3>LAUNDARY</h3>
   ...
   Aananda provides the Facility of LAUNDARY to the Senior Citizen.
        ...
        <div  className = "Lodg" >
         <div className="Lodg_1">
  <img  className="img-responsive"  src="../image/picserve_laundary_3.jpg" width="70%" />


          </div>
          <div className="Lodg_1">
  <img  className="img-responsive"  src="../image/picserve_laundry_1.jpg" width="70%" />


          </div>
          <div className="Lodg_1">
  <img  className="img-responsive"  src="../image/picserv_laundary_2.jpg" width="70%" />
...
<h3>COMPLETE MEDICAL FACILITY EXCEPT(CANCER, HEART SURGERY)</h3>
   ...
   Aananda provides the COMPLETE MEDICAL FACILITY EXCEPT(CANCER, HEART SURGERY)  to the Senior Citizen and also Aananda is the FIRST REHABILATION HOUSE FOR SENIOR CITIZEN IN INDIA who provides this type of Service. Its the Proud Movement for the Aananda.
        ...
        <div  className = "Lodg" >
         <div className="Lodg_1">
         <img  className="img-responsive"  src="../image/picserv.jpg" width="70%" />


          </div>
          <div className="Lodg_1">
<img  className="img-responsive"  src="../image/picserv_11.jpg" width="70%" />


          </div>
          <div className="Lodg_1">

<img  className="img-responsive"  src="../image/pichealth.jpg" width="70%" />
